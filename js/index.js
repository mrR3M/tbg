        ...
        function changeMotionStatus(status) {
          ...
          if (obj) {
            ...
            newLine("You are now " + obj.verb + ", your movement volume level is " + obj.volume);
            newLine("");
          } else {
        ...
        function help() {
          var helptext = [
            ...
            "Movement commands",
            "- RUN: Loud but fast.",
            "- WALK: Quiet but slower than running.",
            "- CRAWL: Quietest but slower than walking.",
            "- MOVE [direction]: Move in a direction (north/south/east/west)",
            "-------",
            "Action commands",
            "- LOOK: Look around, get a description of your surroundings",
            "- PICKUP [object]: Add an object to your inventory",
            "- USE [object] WITH [object]: Use an object",
            "-------",
            "Other commands",
            "- NARRATIVE: Show the last narrative",
  ...
  return false;
        ...
        window.part = "1.0";
        window.obj = {};
        window.story = $.parseJSON('{"story":{"part":[{"partId":1.0,"content":[{"narration":"You wake. A pain surges through your body as your eyes slowly adjust to your surroundings."},{"narration":"All around you are flames, twisted metal, sparking electronic equipment. The heat is unbearable."},{"narration":"You need to get out of here. Fast."},{"narration":"...."},{"narration":"For the controls, type \'help\' and hit enter."}],"movement":[{"key":"north","passable":false,"inspection":"To the north is only fire, you would never make it through, not without serious injuries anyway"},{"key":"east","passable":false,"inspection":"The east is blocked off by a pile of rubble"},{"key":"south","passable":true,"part":1.3,"inspection":"The south passage is clear, leading to the exit"},{"key":"west","passable":true,"part":1.1,"inspection":"To the west is a small service room, it looks like there is something on the floor"}],"actions":[]},{"partId":1.1,"content":[{"narration":"You head west, away from the flames, in to the small service room."},{"narration":"The smoke is rising towards a fire alarm, once it is triggered the door will seal."},{"narration":"You notice a wrench on the floor, that could be useful."}],"movement":[{"key":"north","passable":false,"inspection":"To the north is only a solid wall"},{"key":"east","passable":true,"part":1.11,"inspection":"To the east is the only exit, leading back in to the previous room"},{"key":"south","passable":true,"inspection":"To the south the passage way has collapsed, blocking your path"},{"key":"west","passable":false,"inspection":"To the west is only a solid, highly damaged wall"}],"actions":{"pickup":[{"key":"wrench","description":"heavy steel","weight":15}]}},{"partId":1.11,"content":[{"narration":"The flames have worsened and toxic smoke clouds are filling the room."},{"narration":"The door seals behind you and an alarm sounds"}],"movement":[{"key":"north","passable":false,"inspection":"To the north is only fire, you would never make it through, not without serious injuries anyway"},{"key":"east","passable":false,"inspection":"The east is blocked off by a pile of rubble"},{"key":"south","passable":true,"part":1.3,"inspection":"he south passage is clear, leading to the exit"},{"key":"west","passable":false,"inspection":"The door is sealed shut, there is no way past now"}],"actions":[]},{"partId":1.12,"content":[{"narration":"The flames are intense and smoke is building, you start coughing."},{"narration":"You need to find a tool to unlock the door but there is nothing in this room."}],"movement":[{"key":"north","passable":false,"inspection":"To the north is only fire, you would never make it through, not without serious injuries anyway"},{"key":"east","passable":false,"inspection":"The east is blocked off by a pile of rubble"},{"key":"south","passable":true,"part":1.3,"inspection":"The south passage is clear, leading to the exit"},{"key":"west","passable":true,"part":1.1,"inspection":"The room to the west is clear and it looks like there is something on the floor"}],"actions":[]},{"partId":1.3,"content":[{"narration":"The exit is ahead, but the door is sealed shut"},{"narration":"You\'ll need to find a tool of some kind to unlock the door."}],"movement":[{"key":"north","passable":true,"part":"1.12","inspection":"North leads back where you started, but maybe you\'ll find a tool to open the door"},{"key":"east","passable":false,"inspection":"To the east is a solid wall"},{"key":"south","passable":false,"inspection":"The exit door is ahead, but locked shut"},{"key":"west","passable":false,"inspection":"To the west is a solid wall"}],"actions":{"use":[{"key":"wrench","event":"You use your wrench to break the lock and the door swings open","loseItem":true,"part":2}]}},{"partId":2,"content":[{"narration":"That\'s it. You\'ve made it out of the room!"},{"narration":"Thanks for playing my text game :)"}]}]}}');
go();   
